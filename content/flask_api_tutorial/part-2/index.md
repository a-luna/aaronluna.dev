...
[In Part 1](/series/flask-api-tutorial/part-1/#the-application-factory-pattern), we created an instance of the Flask-SQLAlchemy extension with the name `db` in the `app/__init__.py` file and initialized it in the `create_app` method. The `db` object contains functions and classes from `sqlalchemy` and `sqlalchemy.orm`.
...
app/api/widgets/__init__.py::BLACK PASSED                                                                       [ 43%]
app/api/widgets/__init__.py::FLAKE8 PASSED                                                                      [ 46%]
...
app/api/widgets/__init__.py::BLACK PASSED                                                                       [ 37%]
app/api/widgets/__init__.py::FLAKE8 PASSED                                                                      [ 40%]
